...
primary metric is the IRC-validated \emph{intended-reaction success rate} (forward and
...
\item \textbf{Crossover, not a point.} GAD is statistically indistinguishable
  ...
  45.3\% vs.\ 23.7\%). The same crossover holds for saddle-convergence and across
  \fmax{} thresholds.
...
\begin{itemize}
\item \textbf{Intended-reaction success rate (IRC) --- primary.} Did we find the
...
\item \textbf{Saddle-convergence rate --- secondary.} Did the optimizer reach
...
\section{Results}
% =====================================================================
\subsection{Primary result: intended-reaction success (IRC) crosses over with guess quality}\label{sec:primary}

\begin{figure}[H]\centering
\includegraphics[width=0.72\textwidth]{figures_new/fig_intended_success_single.pdf}
\caption{\textbf{Primary metric: intended-reaction success rate (IRC) vs.\
initial-guess noise}, $n=287$. Methods coincide at low noise; GAD and the hybrid
retain far more intended reactions as the guess degrades.
(Saddle-convergence is shown separately in Fig.~\ref{fig:conv}.)}
\label{fig:primary}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.66\textwidth]{figures_new/fig_intended_success_delta.pdf}
\caption{\textbf{Intended success for all three methods; the GAD$-$Sella gap is
...
\item \textbf{Significance.} McNemar on paired per-sample intended outcomes:
  ...
  saddle-convergence and across \fmax{} thresholds (Section~\ref{sec:fmax}).
\end{itemize}

\begin{table}[H]\centering\small
\caption{\textbf{Primary metric --- intended-reaction success rate (IRC), \%},
$n=287$, from the fresh per-sample re-validation (GAD $dt{=}0.003$); Sella $=$
strongest baseline. Saddle-convergence is reported separately in
...
\subsection{Secondary: saddle-convergence and the \texorpdfstring{$\fmax$}{Fmax} plateau}\label{sec:fmax}
...
\item \textbf{Crossover here too} (Fig.~\ref{fig:conv}, Table~\ref{tab:conv}). At
  ...
  saddle-convergence (92.7 vs.\ 89.2\% @ \SI{10}{pm}); GAD overtakes by
...
\caption{\textbf{Secondary metric: saddle-convergence rate}
...
\begin{table}[H]\centering\small
\caption{Saddle-convergence rate (\%, $\nneg{=}1\wedge\fmax{<}0.01$, $n=287$).}
\label{tab:conv}
\begin{tabular}{l cccccc}
\toprule
\textbf{Saddle-convergence \%} & \textbf{10\pm} & \textbf{30\pm} & \textbf{50\pm} & \textbf{100\pm} & \textbf{150\pm} & \textbf{200\pm} \\
\midrule
...
\item \textbf{It lives on the secondary axis.} Intended success
...
\caption{\textbf{The $\fmax$ plateau} (convergence vs.\ threshold; tighter to the
right). GAD drops vertically near $0.01$; Sella and the hybrid descend into
$0.005$ via Newton landing.}
\label{fig:plateau}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.95\textwidth]{figures_new/fig_fmax_plateau_grid.pdf}
\caption{\textbf{Convergence vs.\ $\fmax$ threshold, all six noise levels.} The
GAD cliff at $0.005$ is universal.}
\label{fig:grid}
\end{figure}
...
\item When the analytic Hessian is cheap, the limiting factor is the step, not
  ...
  metric that matters (intended success) precisely where large Newton/RFO jumps
...
\caption{Intended-reaction success \% (top) and saddle-convergence \% (bottom), all
...
low noise (96.5 vs.\ 92.7\% @ \SI{10}{pm}) but lowers intended success at every
...
% =====================================================================
\clearpage
\section{Extended figure gallery (all figures)}\label{app:gallery}
% Auto-generated 2026-06-23: every available figure, each captioned with its
% source path so it is unambiguous. Some repeat main-text figures by design.
Every figure produced for this work, captioned by source path. Figures in
\texttt{figures\_new/} are built from the fresh test-287 5-tier IRC
(\texttt{scripts/build\_figures\_new.py}); the \texttt{figures\_2026\_05\_16/}
and \texttt{figures/} sets are the report's all-method comparison charts.


\subsection*{Manuscript figures (\texttt{figures\_new/})}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_d1_vs_d3.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_d1\_vs\_d3.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_fmax_plateau.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_fmax\_plateau.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_fmax_plateau_grid.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_fmax\_plateau\_grid.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_intended_success.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_intended\_success.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_intended_success_delta.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_intended\_success\_delta.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_intended_success_single.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_intended\_success\_single.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_outcome_grouped_intended.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_outcome\_grouped\_intended.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_outcome_stacked.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_outcome\_stacked.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_outcome_stacked_counts.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_outcome\_stacked\_counts.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_pareto.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_pareto.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_reactant_scope.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_reactant\_scope.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_rmsd_vs_noise.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_rmsd\_vs\_noise.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_saddle_convergence.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_saddle\_convergence.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_steps.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_steps.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_new/fig_walltime.pdf}
\caption*{\footnotesize\texttt{figures\_new/fig\_walltime.pdf}}
\end{figure}
\clearpage

\subsection*{Report figure set (\texttt{figures\_2026\_05\_16/})}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_d1_vs_d3.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_d1\_vs\_d3.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_fmax_decay_gad_vs_hybrid.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_fmax\_decay\_gad\_vs\_hybrid.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_fmax_plateau.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_fmax\_plateau.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_longbudget.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_longbudget.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis_fmax0p001.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis\_fmax0p001.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis_fmax0p005.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis\_fmax0p005.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis_fmax0p01.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis\_fmax0p01.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis_fmax0p023.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis\_fmax0p023.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_main_4axis_fmax0p05.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_main\_4axis\_fmax0p05.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_pareto_per_noise.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_pareto\_per\_noise.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_ranking_lollipop_high.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_ranking\_lollipop\_high.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_ranking_lollipop_low.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_ranking\_lollipop\_low.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_reactant_bar.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_reactant\_bar.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_rmsd_to_ts.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_rmsd\_to\_ts.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures_2026_05_16/fig_topo_recovery.pdf}
\caption*{\footnotesize\texttt{figures\_2026\_05\_16/fig\_topo\_recovery.pdf}}
\end{figure}

\subsection*{All-method / multi-line comparison charts (\texttt{figures/})}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_master_4axis.pdf}
\caption*{\footnotesize\texttt{figures/fig\_master\_4axis.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_full_sweep_grid.pdf}
\caption*{\footnotesize\texttt{figures/fig\_full\_sweep\_grid.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_all_methods_conv.pdf}
\caption*{\footnotesize\texttt{figures/fig\_all\_methods\_conv.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_all_methods_wall.pdf}
\caption*{\footnotesize\texttt{figures/fig\_all\_methods\_wall.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_all_methods_tsph.pdf}
\caption*{\footnotesize\texttt{figures/fig\_all\_methods\_tsph.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_conv_5methods.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_conv\_5methods.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_irc_topo_5methods.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_irc\_topo\_5methods.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_irc_rmsd_all_classes_5methods.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_irc\_rmsd\_all\_classes\_5methods.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_irc_topo_all_classes_5methods.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_irc\_topo\_all\_classes\_5methods.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_conv_3m.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_conv\_3m.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_cmp_irc_topo_3m.pdf}
\caption*{\footnotesize\texttt{figures/fig\_cmp\_irc\_topo\_3m.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_irc_intended_grouped_3m.pdf}
\caption*{\footnotesize\texttt{figures/fig\_irc\_intended\_grouped\_3m.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_conv_overlay.pdf}
\caption*{\footnotesize\texttt{figures/fig\_conv\_overlay.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_irc_overlay.pdf}
\caption*{\footnotesize\texttt{figures/fig\_irc\_overlay.pdf}}
\end{figure}
\clearpage
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_noise_sweep_with_irc.pdf}
\caption*{\footnotesize\texttt{figures/fig\_noise\_sweep\_with\_irc.pdf}}
\end{figure}
\begin{figure}[h]\centering
\includegraphics[width=0.82\textwidth,height=0.40\textheight,keepaspectratio]{figures/fig_noise_sweep_unified.pdf}
\caption*{\footnotesize\texttt{figures/fig\_noise\_sweep\_unified.pdf}}
\end{figure}
