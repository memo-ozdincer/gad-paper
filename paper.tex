...
more intended reactions as it degrades. (Saddle-convergence is shown separately
in Fig.~\ref{fig:conv}.)}
\label{fig:primary}
\end{figure}
...
Saddle-convergence rate (\%, $y$) vs.\ the $\fmax$ threshold ($x$, log axis,
...
\caption{\textbf{Saddle-convergence vs.\ $\fmax$ threshold, one panel per noise
